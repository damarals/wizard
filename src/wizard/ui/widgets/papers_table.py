...
from PySide6.QtWidgets import (
    ...
    QWidget, QHBoxLayout, QPushButton, QMenu, QAction, QLabel,
    QStyle
)
from PySide6.QtCore import Qt, Signal
from PySide6.QtGui import QIcon, QBrush, QColor

from ...core.scraper import Article
...
class PapersTableWidget(QTableWidget):
    ...
    def setup_table(self):
        ...
        self.setHorizontalHeaderLabels(["Title", "Authors", "Year", "Journal", "DOI"])
    ...
    def show_context_menu(self, position):
        ...
        if selected_articles:
            ...
            copy_title = copy_menu.addAction("Title")
            copy_title.triggered.connect(lambda: self.copy_to_clipboard(selected_articles, "title"))
            
            copy_authors = copy_menu.addAction("Authors")
            copy_authors.triggered.connect(lambda: self.copy_to_clipboard(selected_articles, "authors"))
