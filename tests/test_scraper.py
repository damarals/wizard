...
from wizard.core.scraper import ArticleScraper, Article
...
class TestArticleScraper:
    ...
    def test_get_total_pages(self, sample_html_search_results):
        ...
        pagination = soup.new_tag('nav', **{'class': 'br-pagination', 'data-total': '120', 'data-per-page': '30'})
    ...
    def test_search(self, mock_session_class, mock_scraper, sample_articles):
        ...
        mock_scraper.get_all_article_listings = MagicMock(return_value={"Climate AI": [{"article_id": "ABC123"}]})
